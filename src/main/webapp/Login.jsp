...
<head>
	...
	<!-- login.css contains all login-specific styles; global style.css is not loaded here to avoid overrides -->
...
<body>
			...
			<div class="login-body">
				...
				<form method="post" action="<%=request.getContextPath()%>/login" class="login-form" novalidate>
					...
					<div class="input-with-icon">
						...
						<button type="button" class="icon-right toggle-visibility" aria-label="Hiển thị mật khẩu" onclick="toggleVisibility('password', this)">
							<svg class="eye-open" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.2"/></svg>
							<svg class="eye-closed" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.94 17.94A10.94 10.94 0 0112 19c-6 0-10-7-10-7a20.27 20.27 0 013.59-4.14" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M1 1l22 22" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
						</button>
					</div>
					...
					<div class="login-links">
						<div>Chưa có tài khoản? <a href="<%=request.getContextPath()%>/register" class="link-register">Đăng ký ngay</a></div>
					</div>
	...
	<script>
		// Toggle visibility helper (matches Register.jsp behavior)
